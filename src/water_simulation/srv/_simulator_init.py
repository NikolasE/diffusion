"""autogenerated by genmsg_py from simulator_initRequest.msg. Do not edit."""
...
class simulator_initRequest(roslib.message.Message):
  _md5sum = "c1f9e02f338bdc7e872ecfd5020f6e1c"
  _type = "water_simulation/simulator_initRequest"
...
"""
  __slots__ = ['land_img','id','reset_water','viscosity']
  _slot_types = ['sensor_msgs/Image','int32','bool','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       land_img,id,reset_water,viscosity
    ...
    """
    if args or kwds:
      super(simulator_initRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_iBf.pack(_x.id, _x.reset_water, _x.viscosity))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.reset_water, _x.viscosity,) = _struct_iBf.unpack(str[start:end])
...
"""autogenerated by genmsg_py from simulator_initResponse.msg. Do not edit."""
import roslib.message
import struct


class simulator_initResponse(roslib.message.Message):
  _md5sum = "a11ec58c43badf602c0e13a7fc4f2fb8"
  _type = "water_simulation/simulator_initResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(simulator_initResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class simulator_init(roslib.message.ServiceDefinition):
  _type          = 'water_simulation/simulator_init'
  _md5sum = 'c06cd3027532da32a53a8469ff637df1'
  _request_class  = simulator_initRequest
  _response_class = simulator_initResponse
